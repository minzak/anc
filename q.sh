...
sqlite3 -echo -box data.db 'SELECT COUNT(*) AS count FROM Dosar WHERE depun = "2023-12-14";'
...
sqlite3 -echo -box data.db 'SELECT COUNT(*) AS count FROM Dosar WHERE depun = "2023-12-19";'
